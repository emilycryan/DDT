      ...
      <section style={sectionStyles}>
        ...
        <ul style={{ listStyle: 'none', padding: 0, marginBottom: '2rem' }}>
          <li style={listItemStyles}>
            ...
            <strong style={{ color: 'var(--primary-dark)' }}>Before a Visit</strong>
            {' —'} Send educational links to patients to prepare for discussions about risk factors and lifestyle changes
          </li>
          <li style={listItemStyles}>
            <span style={bulletStyles} />
            <strong style={{ color: 'var(--primary-dark)' }}>During Counseling</strong>
            {' —'} Reference specific modules or tools to support goal-setting
          </li>
          <li style={listItemStyles}>
            <span style={bulletStyles} />
            <strong style={{ color: 'var(--primary-dark)' }}>After a Visit</strong>
        ...
        <ul style={{ listStyle: 'none', padding: 0, marginBottom: '2rem' }}>
          <li style={listItemStyles}>
            <span style={bulletStyles} />
            <strong style={{ color: 'var(--primary-dark)' }}>CDC Diabetes Path to Prevention</strong>
          ...
          <li style={listItemStyles}>
            <span style={bulletStyles} />
            <strong style={{ color: 'var(--primary-dark)' }}>Community Preventive Services Task Force</strong>
