  ...
  return (
    <TipsPageLayout title="Meal Planning on a Budget">
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: '2.5rem', fontWeight: 700, fontFamily: 'var(--font-body)', color: '#f0f4f8', marginBottom: '0.5rem' }}>$3,500</div>
              ...
              <React.Fragment key={i}>
                <div style={{ padding: '1rem', borderBottom: i < weeklyResetSteps.length - 1 ? '1px solid rgba(255,255,255,0.2)' : 'none' }}>
                  <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
                    <div style={{ width: 28, height: 28, borderRadius: '50%', backgroundColor: '#d83933', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.875rem', fontWeight: 700, flexShrink: 0 }}>{i + 1}</div>
                    <div>
