...
const StressCardiovascularRisk = () => {
  ...
  return (
    <ResourcePageLayout categoryLabel="Heart Health" categoryPath="/learn/heart-health/know-your-numbers" pageSequence={PAGE_SEQUENCE} title="Stress & Cardiovascular Risk">
      <p
        style={{
          fontSize: '1rem',
