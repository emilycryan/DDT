...
// Config: one question at a time. Add your questions here; each option can have a score for totaling.
                ...
                return (
                  <label
                    ...
                    style={{
                      ...
                      marginBottom: '0.75rem',
                      cursor: 'pointer',
                      border: selected ? '2px solid var(--primary-dark)' : '2px solid transparent',
                      backgroundColor: 'var(--bg-primary)',
                    }}
                  >
                    <input
