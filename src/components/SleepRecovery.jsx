...
const SleepRecovery = () => {
  ...
  return (
    <ResourcePageLayout categoryLabel="Healthy Living" categoryPath="/resources/healthy-living/building-healthy-habits" pageSequence={PAGE_SEQUENCE} title="Sleep & Recovery">
      ...
      >
        <div>
          <div style={{ fontSize: '2.5rem', fontWeight: 700, fontFamily: 'var(--font-body)', color: '#f9dede', marginBottom: '0.5rem' }}>1 in 3</div>
        ...
        <div>
          <div style={{ fontSize: '2.5rem', fontWeight: 700, fontFamily: 'var(--font-body)', color: '#f9dede', marginBottom: '0.5rem' }}>50-70M</div>
          <div style={{ fontSize: '0.9375rem', opacity: 0.95, lineHeight: 1.4 }}>
      ...
      >
        <div>
          ...
          >
            <div style={{ fontFamily: 'var(--font-body)', fontWeight: 600, fontSize: '0.9375rem', color: '#d83933', marginBottom: '0.25rem' }}>
              Sleep Debt Is Real
            </div>
