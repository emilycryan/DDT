...
const PractitionerFeedback = () => {
  ...
  if (submitted) {
    return (
      <main style={{ backgroundColor: 'var(--bg-secondary)', minHeight: '80vh' }}>
  ...
  return (
    <main style={{ backgroundColor: 'var(--bg-secondary)', minHeight: '80vh', paddingBottom: '3rem' }}>
      {/* Hero */}
      <section style={{
        backgroundColor: 'var(--bg-primary)',
      ...
      <form onSubmit={handleSubmit}>
        ...
        <section style={sectionStyles}>
          ...
          <fieldset style={{ ...fieldsetStyles, paddingTop: '1.5rem' }}>
            ...
            {['Risk assessment tools', 'Patient-friendly education content', 'Lifestyle guidance', 'Referral pathways (e.g., National DPP)', 'Printable materials', 'Visual explanations', 'Other'].map(opt => (
              <label key={opt} style={{ display: 'flex', alignItems: 'center', marginBottom: '0.5rem', cursor: 'pointer' }}>
