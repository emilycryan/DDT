...
const MentalHealthResilience = () => {
  ...
  return (
    <ResourcePageLayout categoryLabel="Healthy Living" categoryPath="/learn/healthy-living/building-healthy-habits" pageSequence={PAGE_SEQUENCE} title="Mental Health & Resilience">
      <p
        style={{
          fontSize: '1rem',
