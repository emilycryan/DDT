...
const HeartHealthyEating = () => {
  ...
  return (
    <ResourcePageLayout categoryLabel="Heart Health" categoryPath="/resources/heart-health/know-your-numbers" pageSequence={PAGE_SEQUENCE} title="Heart-Healthy Eating">
      <p
        style={{
          fontSize: '1rem',
      ...
      >
        <div>
          ...
          >
            Dietary Approaches to Stop Hypertension. The DASH eating plan is consistently ranked among the best evidence-based approaches for lowering blood pressure and improving cholesterol — without medication.
          </p>
          <p
            style={{
              fontSize: '1rem',
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            {dashGoals.map((row, i) => (
              ...
              >
                <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.9375rem', color: '#1b1b1b', fontWeight: row.highlight ? 600 : 400 }}>{row.item}</span>
                <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.9375rem', fontWeight: row.highlight ? 600 : 400, color: row.highlight ? '#d83933' : '#323a45' }}>
                  {row.value}
                </span>
              </div>
            ))}
      ...
      >
        ...
        >
          <h3 style={{ fontFamily: 'var(--font-body)', fontWeight: 600, fontSize: '1.125rem', color: '#1b1b1b', margin: '0 0 1rem 0' }}>
            Prioritize
          </h3>
