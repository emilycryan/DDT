...
const movementCards = [
  {
    ...
    topBarColor: '#d83933',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#d83933" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    topBarColor: '#007833',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#007833" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    topBarColor: '#1b1b1b',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#1b1b1b" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    topBarColor: '#d83933',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#d83933" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <TipsPageLayout title="Moving More When You're Busy">
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: '2.5rem', fontWeight: 700, fontFamily: 'var(--font-body)', color: '#007833', marginBottom: '0.5rem' }}>350+</div>
          <div style={{ fontSize: '0.9375rem', opacity: 0.95, lineHeight: 1.4 }}>
      ...
      <div style={{
        ...
        <div>
          <h2 style={{ fontSize: isMobile ? '1.5rem' : '1.75rem', fontFamily: 'var(--font-body)', fontWeight: 600, color: '#1b1b1b', margin: '0 0 0.75rem 0' }}>
            ...
            {exerciseSnacks.map((item, i) => (
              <div
                ...
                style={{
                  ...
                  backgroundColor: item.dark ? '#1b1b1b' : '#f0f4f8',
                  display: 'flex',
                  gap: '0.75rem',
              ...
              >
                ...
                />
                <div>
                  <div style={{ fontFamily: 'var(--font-body)', fontWeight: 600, fontSize: '0.9375rem', color: item.dark ? 'white' : '#1b1b1b', marginBottom: '0.25rem' }}>{item.title}</div>
                  <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.875rem', color: item.dark ? 'rgba(255,255,255,0.9)' : '#323a45', lineHeight: 1.5, margin: 0 }}>{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <h2 style={{ fontSize: isMobile ? '1.5rem' : '1.75rem', fontFamily: 'var(--font-body)', fontWeight: 600, color: '#1b1b1b', margin: '0 0 0.5rem 0' }}>
        Making Movement Automatic
      </h2>
      ...
      <div style={{
        ...
        {movementCards.map((card, i) => (
          ...
          >
            ...
            <h3 style={{ fontFamily: 'var(--font-body)', fontWeight: 600, fontSize: '1rem', color: '#1b1b1b', margin: '0 0 0.5rem 0' }}>{card.title}</h3>
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.9375rem', color: '#323a45', lineHeight: 1.5, margin: 0 }}>{card.desc}</p>
          </div>
        ))}
      </div>
    </TipsPageLayout>
