...
const BuildingHealthyHabits = () => {
  ...
  return (
    <ResourcePageLayout categoryLabel="Healthy Living" categoryPath="/learn/healthy-living/building-healthy-habits" pageSequence={PAGE_SEQUENCE} title="Building Healthy Habits">
      <p
        style={{
          fontSize: '1rem',
