...
const SocialConnection = () => {
  ...
  return (
    <ResourcePageLayout categoryLabel="Healthy Living" categoryPath="/resources/healthy-living/building-healthy-habits" pageSequence={PAGE_SEQUENCE} title="Social Connection">
      <p
        style={{
          fontSize: '1rem',
      ...
      >
        <div>
          <div style={{ fontSize: '2.5rem', fontWeight: 700, fontFamily: 'var(--font-body)', color: '#f9dede', marginBottom: '0.5rem' }}>26%</div>
        ...
        <div>
          <div style={{ fontSize: '2.5rem', fontWeight: 700, fontFamily: 'var(--font-body)', color: '#f9dede', marginBottom: '0.5rem' }}>61%</div>
          <div style={{ fontSize: '0.9375rem', opacity: 0.95, lineHeight: 1.4 }}>
            of Americans report feeling lonely — a figure that has risen steadily over the past two decades across all age groups
          </div>
        </div>
        <div>
          <div style={{ fontSize: '2.5rem', fontWeight: 700, fontFamily: 'var(--font-body)', color: '#f9dede', marginBottom: '0.5rem' }}>15 cigs</div>
          <div style={{ fontSize: '0.9375rem', opacity: 0.95, lineHeight: 1.4 }}>
