...
const SocialConnection = () => {
  ...
  return (
    <ResourcePageLayout categoryLabel="Healthy Living" categoryPath="/learn/healthy-living/building-healthy-habits" pageSequence={PAGE_SEQUENCE} title="Social Connection">
      <p
        style={{
          fontSize: '1rem',
